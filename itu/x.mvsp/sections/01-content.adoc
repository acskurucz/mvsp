...
In order to provide context on how the MVSP controls align to common security standards, please take a look at this comparison in OSCAL format between MVSP and commonly used standards.
