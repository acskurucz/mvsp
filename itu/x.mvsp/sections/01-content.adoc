...
In order to provide context on how the MVSP controls align to common security standards, please take a look at [this](https://viewer.oscal.io/?url=https%3A%2F%2Fraw.githubusercontent.com%2Fvendorsec%2Fmvsp%2Fmaster%2Foscal%2Fmvsp%2FMVSP_v3.0-20231109-mapping-catalog.json) comparison in OSCAL format between MVSP and commonly used standards.
